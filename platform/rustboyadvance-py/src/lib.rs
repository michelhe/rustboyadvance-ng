...
impl RustGba {
    ...
    fn add_stop_addr(&mut self, stop_addresses : Vec<(u32,i16,bool,String,u32)> ) -> PyResult<()> {
        if let Some(core) = &mut self.core {
           for (addr, value, is_active, name, id) in stop_addresses {
                debug!(
                    "Adding stop address: addr={}, value={}, is_active={}, name={}, id={}",
